...
namespace Quản_lý_bán_hàng_siêu_thị
{
    public partial class BanHang : Form
    {
        ...
        private void dtg_QLBH_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (btnThem.Enabled == false)
            {
                MessageBox.Show("Đang ở chế độ thêm mới!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void cbxTimKiemTheo_SelectedIndexChanged_1(object sender, EventArgs e)
        {
            cbxTimKiemTheo.DisplayMember = "Text";
            cbxTimKiemTheo.ValueMember = "Value";
        ...
        private void cbxTimKiemTheo_Click_1(object sender, EventArgs e)
        {
            cbxTimKiemTheo.DisplayMember = "Text";
            cbxTimKiemTheo.ValueMember = "Value";
